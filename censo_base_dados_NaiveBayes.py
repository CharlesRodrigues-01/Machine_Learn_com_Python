...
''' previsão de acerto deste algoritmo ficou em 48%, inviabilizando a 
utilização do mesmo para este caso específico. Ao ignorar o escalonamento, neste 
caso, a previsão de acertos sobe para 79%.'''